Pod::Spec.new do |s|
        ...
        s.source   = {:http =>"https://p-template-hk.oss-cn-hongkong.aliyuncs.com/ios_sdk/orangefilter.zip"}
        ...
        s.subspec 'orangefilter-all_no_ar' do |sdan|
                ...
                sdan.ios.vendored_libraries = 'libs/libwebp.a', 'libs/libdraco.a'
        end
