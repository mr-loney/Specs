Pod::Spec.new do |s|
    ...
    s.source = { :http => "ftp:///Users/pengjun/Documents/money/ios_sdk/mediafoundation.zip" }
    ...
    s.dependency 'VNN/vnn-all'#, :path => '/Users/pengjun/Documents/money/ios_sdk/VNN.spec'
