Pod::Spec.new do |s|
    ...
    s.requires_arc = true
    s.source = {:http => "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/ios_sdk/xyplayer-ios_55.zip"}
    ...
    s.subspec 'transvodstatic' do |s1|
      ...
      s1.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/xyplayer-ios"' }
