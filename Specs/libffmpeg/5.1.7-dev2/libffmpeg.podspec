Pod::Spec.new do |s|
	...
	s.source       = {:http =>"https://p-template-hk.oss-cn-hongkong.aliyuncs.com/macos_sdk/ffmpeg/ffmpeg_1.1_20251029_043513.zip"}
	...
	s.subspec 'ffmpeg-static-macOS' do |sp|
		...
		sp.libraries = 'avcodec', 'avdevice', 'avfilter', 'avformat', 'avutil', 'postproc', 'swresample', 'swscale', 'x264'
	end
